...
var current_controlled_elemental: Elemental:
	set(value):
		if current_controlled_elemental:
			...
			if current_controlled_elemental.hp_changed.is_connected(_on_elemental_hp_changed):
				current_controlled_elemental.hp_changed.disconnect(_on_elemental_hp_changed)
		...
		if current_controlled_elemental:
			...
			current_controlled_elemental.hp_changed.connect(_on_elemental_hp_changed)
...
func _on_elemental_hp_changed(_hp: int, _max_hp: int) -> void:
	_update_ui()
