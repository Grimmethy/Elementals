...
func _collect_neighbor_targets() -> Array[Vector3]:
	# This function is now deprecated, logic moved to _choose_new_target
	return []
...
func _configure_particles() -> void:
	...
	if not flame_particles.draw_pass_1:
		...
		flame_particles.draw_pass_1 = pass_mesh
