...
func _play_whack() -> void:
	## Plays the "whack" sound effect.
	var whack_player = get_node_or_null("WhackPlayer")
	if whack_player:
		whack_player.play()
...
func _show_thwak_visual(pos: Vector3) -> void:
	...
	var texture_path = "res://assets/generated/thwak_popup_frame_0_1774916398.png"
...
func _play_swoosh() -> void:
	## Plays the headbutt/swoosh sound effect.
	var player = get_node_or_null("SwooshPlayer") as AudioStreamPlayer3D
	if player and player.stream:
		player.play()
