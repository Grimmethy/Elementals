...
enum State { GRASS, DIRT, MUD, FIRE, PUDDLE, STONE, TREE, BURNING_TREE, STUMP, BURNT_STUMP, BURNING_BURNT_STUMP }
...
func _update_debug_label() -> void:
	...
	match current_state:
		...
		State.BURNING_TREE:
			text = "%d" % ceil(10.0 - tree_burn_duration)
		State.STUMP:
...
func _update_appearance() -> void:
	...
	if fire_particles:
		fire_particles.emitting = (current_state == State.FIRE or current_state == State.BURNING_TREE or current_state == State.BURNING_BURNT_STUMP)
...
func apply_fire() -> bool:
	match current_state:
		...
		State.BURNT_STUMP:
			...
			burnt_stump_burn_duration = 0.0
			return true
		State.FIRE, State.STONE, State.BURNING_TREE, State.STUMP, State.BURNING_BURNT_STUMP:
			return false
	return false
