...
func _on_movement_finished() -> void:
	...
	if target_tile.type == TileConstants.Type.FIRE:
...
func _on_health_depleted() -> void:
	if current_state_node:
		var is_fire = (tile and tile.type == TileConstants.Type.FIRE)
...
func _process(delta: float) -> void:
	...
	var on_fire = tile and tile.type == TileConstants.Type.FIRE
	if on_fire:
