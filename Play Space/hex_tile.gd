...
## Signal emitted when the tile's state changes.
...
## Normalized directions for pointy-topped hex grid neighbors.
## Order: E, NE, NW, W, SW, SE
static var DIRECTIONS: Array[Vector3] = [
	Vector3(1, 0, 0),
	Vector3(0.5, 0, -0.866025),  # -sqrt(3)/2
	Vector3(-0.5, 0, -0.866025),
	Vector3(-1, 0, 0),
	Vector3(-0.5, 0, 0.866025),   # sqrt(3)/2
	Vector3(0.5, 0, 0.866025)
]

## Fixed neighbor slots for directional lookups. Order matches DIRECTIONS.
var neighbor_slots: Array[HexTile] = []
