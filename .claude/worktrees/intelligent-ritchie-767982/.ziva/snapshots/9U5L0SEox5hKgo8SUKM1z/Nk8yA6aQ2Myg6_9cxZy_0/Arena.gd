...
func _update_debug_info() -> void:
	...
	text += "Grass: %d\n" % counts[HexTile.State.GRASS]
	text += "Dirt: %d\n" % counts[HexTile.State.DIRT]
	text += "Mud: %d\n" % counts[HexTile.State.MUD]
	text += "Puddle: %d\n" % counts[HexTile.State.PUDDLE]
	text += "Fire: %d\n" % counts[HexTile.State.FIRE]
	text += "Stone: %d" % counts[HexTile.State.STONE]
