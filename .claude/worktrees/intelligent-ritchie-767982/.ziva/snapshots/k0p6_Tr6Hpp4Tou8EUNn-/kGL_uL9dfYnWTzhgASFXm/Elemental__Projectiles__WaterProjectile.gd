...
@export var sprite_pixel_size: float = 0.02
...
@export var sprite_base_modulate: Color = Color(1.0, 1.2, 1.5, 1.0) # Light blue tint
...
func _create_sprites(count: int) -> void:
	...
	for i in range(count):
		...
		sprite.texture = load("res://assets/generated/water_jet_particle_frame_0_1774825987.png")
