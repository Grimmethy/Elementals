...
enum State { GRASS, DIRT, MUD, FIRE, PUDDLE, STONE, TREE, BURNING_TREE, STUMP, BURNT_STUMP }
...
func _update_appearance() -> void:
	...
	if fire_particles:
		fire_particles.emitting = (current_state == State.FIRE or current_state == State.BURNING_TREE)
...
func apply_fire() -> bool:
	match current_state:
		...
		State.PUDDLE:
			...
			return true
		State.FIRE, State.STONE, State.BURNING_TREE, State.STUMP:
			return false
	return false
