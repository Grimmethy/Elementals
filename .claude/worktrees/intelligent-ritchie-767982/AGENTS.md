...
**`res://Components/GameClockComponent.gd`** is the single source of truth for all game timing. **ALL timer logic must route through this component.**
...
| Centralized Timing | `Components/GameClockComponent.gd` | Single clock for all game timing |
